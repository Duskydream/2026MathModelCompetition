...
| 项目 | 问题3 | 问题4 |
|---|---|---|
| 默认策略 | `shared`，启用Q3混合调度 | `shared`，共用测站与路线排序 |
| 搜索布局 | 圆心加六环点，共7站 | 950米等边三角网格，共27站 |
| 关键配置 | 环半径1150米；第二测点前向200米、侧向100米 | 一个三角形重心对齐目标圆心；保留与目标圆相交单元的全部顶点 |
| 定位 | 混合安排搜索站与已发现目标；利用目标圆和历史无信号约束保守缩小区域 | 保留既有定位与清除策略 |
