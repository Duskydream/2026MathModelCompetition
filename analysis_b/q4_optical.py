"""Continuous polygon covers for Q4 optical clearing, independent of RF visibility."""
import math
import numpy as np
...
def strip_cover(poly,origin,deg,width,radius):
    """Each clipped slab lies in rectangles whose corners are inside one clear disk."""
